# waste_management_backend/settings.py
import os
from pathlib import Path
from datetime import timedelta  # Make sure to add this import
...
# Uncomment this and comment out the SQLite config above
"""
DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.postgresql',
        'NAME': os.environ.get('DB_NAME', 'waste_management'),
